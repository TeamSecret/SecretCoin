...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About SecretCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>SecretCoin</b> version", 0));
...
"Copyright \302\251 2014 The SecretCoin developers", 0));
