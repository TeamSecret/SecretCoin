...
unsigned int nStakeMaxAge = 365 * 24 * 60 * 60; // 1 year
...
const string strMessageMagic = "SecretCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 <= 16000)
    {
      nSubsidy = 62.5 * COIN;
      return nSubsidy + nFees;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SecretCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Wed, 12 Aug 2015 14:35:16 GMT";
        CTransaction txNew;
        txNew.nTime = 1439390116;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1439390120;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 6850600;
		if(fTestNet)
        {
            block.nNonce   = 6850600;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xc77af4b32052ed6e4b7b58a693c0f5f30ff46bc614292d2607a124e4b8d49a3f"));
        block.print();
